# Generated by Django 2.1.7 on 2022-10-27 17:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.CharField(blank=True, max_length=255, null=True, verbose_name='发起人头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gitee_id', models.CharField(max_length=50, verbose_name='GiteeID')),
        ...
        migrations.AddField(
            model_name='meeting',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='meetings.User'),
        ),
    ]
