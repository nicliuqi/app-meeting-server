...
from opengauss.models import Meeting, Video, User, Group, Record, GroupUser
...
from opengauss.utils.permissions import MaintainerPermission
from opengauss.utils import drivers
from app_meeting_server.utils.common import make_signature, refresh_access
...
class CreateMeetingView(GenericAPIView, CreateModelMixin):
    ...
    def post(self, request, *args, **kwargs):
        data = check_meetings_less_params(request, Group)
