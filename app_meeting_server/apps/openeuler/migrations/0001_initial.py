# Generated by Django 2.2.28 on 2023-10-17 15:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_level', models.SmallIntegerField(choices=[(1, '普通用户'), (2, '活动发起人'), (3, '管理员')], default=1, verbose_name='活动权限')),
                ...
                ('revoke_agreement_time', models.DateTimeField(blank=True, null=True, verbose_name='撤销同意隐私声明时间')),
                ('is_delete', models.SmallIntegerField(choices=[(0, '否'), (1, '是')], default=0, verbose_name='是否删除')),
                ('logoff_time', models.DateTimeField(blank=True, null=True, verbose_name='注销时间')),
            ],
            options={
