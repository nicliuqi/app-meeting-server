...
BILI_VIDEO_PREFIX = DEFAULT_CONF.get('BILI_VIDEO_PREFIX')
...
TEMPLATE_NOT_SUMMARY_NOT_RECORDING = DEFAULT_CONF.get("TEMPLATE_NOT_SUMMARY_NOT_RECORDING")
TEMPLATE_SUMMARY_NOT_RECORDING = DEFAULT_CONF.get("TEMPLATE_SUMMARY_NOT_RECORDING")
TEMPLATE_NOT_SUMMARY_RECORDING = DEFAULT_CONF.get("TEMPLATE_NOT_SUMMARY_RECORDING")
TEMPLATE_SUMMARY_RECORDING = DEFAULT_CONF.get("TEMPLATE_SUMMARY_RECORDING")
TEMPLATE_CANCEL_EMAIL = DEFAULT_CONF.get("TEMPLATE_CANCEL_EMAIL")
SIGS_INFO_OBJECT = DEFAULT_CONF.get('SIGS_INFO_OBJECT')
VIDEO_MINI_SIZE = 1024 * 1024 * 10
...
if FOR_OPENEULER:
    ...
    MEETING_MODEL = DEFAULT_CONF.get('MEETING_MODEL')
    ...
    RECORD_MODEL = DEFAULT_CONF.get('RECORD_MODEL')
    ...
    VIDEO_MODEL = DEFAULT_CONF.get('VIDEO_MODEL')
    WELINK_HOSTS = {
    ...
    GITEE_V5_API_PREFIX = DEFAULT_CONF.get('GITEE_V5_API_PREFIX')
    MAILLIST_MAPPING_URL = DEFAULT_CONF.get('MAILLIST_MAPPING_URL')
    MEETING_MODEL = DEFAULT_CONF.get('MEETING_MODEL')
    OBS_BUCKETNAME_2 = DEFAULT_CONF.get('OBS_BUCKETNAME_2')
    OBS_ENDPOINT_2 = DEFAULT_CONF.get('OBS_ENDPOINT_2')
