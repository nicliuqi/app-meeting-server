"""
Django settings for mindspore_meetings project.
...
ROOT_URLCONF = 'mindspore_meetings.urls'
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_LIFETIME': datetime.timedelta(minutes=1000),
...
WSGI_APPLICATION = 'mindspore_meetings.wsgi.application'
...
MINDSPORE_CANCLE_MEETING_TEMPLATE = os.getenv('MINDSPORE_CANCLE_MEETING_TEMPLATE', '')
